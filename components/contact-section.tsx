...
export function ContactSection() {
  ...
  const contactInfo = [
    { icon: Mail, label: 'Email', value: 'shivanimehra22may@gmail.com', gradient: 'from-blue-500 via-cyan-500 to-teal-500', glowClass: 'glow-blue' },
    { icon: Phone, label: 'Phone', value: '8439358197', gradient: 'from-green-500 via-emerald-500 to-teal-500', glowClass: 'glow-green' },
    { icon: MapPin, label: 'Location', value: 'India', gradient: 'from-purple-500 via-pink-500 to-rose-500', glowClass: 'glow-purple' },
  ];
