...
export function ExperienceSection() {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description: 'Developed machine learning solutions and automation workflows using Python and TensorFlow. Worked on data preprocessing, model training, evaluation, and deployment for real-world AI applications.',
      achievements: [
         'Built and evaluated machine learning models using Python, TensorFlow, and Scikit-learn.',
         'Developed data preprocessing pipelines for efficient model training and analysis.',
         'Automated data processing tasks and improved workflow efficiency using Python.',
         'Analyzed model performance and optimized prediction accuracy through iterative testing.'
      ],
      tags: ['Machine Learning', 'TensorFlow', 'Python', 'Scikit-learn'],
    ...
    },
    {
      ...
      tags: ['TensorFlow', 'CNN', 'Agriculture', 'Computer Vision'],
