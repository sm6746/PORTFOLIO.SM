...
export function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      github: 'https://github.com/sm6746/PORTFOLIO',
      demo: '#',
    },
    {
    ...
    {
      title: '',
      description: 'The Uber Ride Analytics Dashboard is an end-to-end data analytics and visualization project designed to analyze ride booking data and extract actionable business insights. The dashboard provides a comprehensive view of ride volume, vehicle performance, cancellations, ratings, and booking success trends to support data-driven decision-making',
      image: '/assets/images/default.svg',
