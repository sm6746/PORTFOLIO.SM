    ...
    >
      ...
      >
        ...
        <p className="text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
          Recent graduate passionate about creating <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Turning Raw Data into Business Decisions with Analytics & AI. 
